...
//					}
					...
					// ------------------------------------------------------------
					// calculations for the animals treated tab
					// ------------------------------------------------------------

					var $smallAnimal = $('#acf-field_55dc6669f5235');
					var $equine = $('#acf-field_55dc6699f5236');
					var $bovine = $('#acf-field_55dc66d3f5237');
					var $other = $('#acf-field_55dc6713f5238');

					var total;

					function getTotal() {
						total = parseInt($smallAnimal.val()) + parseInt($equine.val()) + parseInt($bovine.val()) + parseInt($other.val());
					}
